...
const SOURCE_CATALOG: SourceTemplate[] = [
  ...
  { id: "tree-squawk", name: "Tree of Alpha Squawk", category: "news", transport: "websocket" },
  { id: "cryptopanic", name: "CryptoPanic Aggregator", category: "news", transport: "rest_poll" },
  { id: "sec-press", name: "SEC Press Wire", category: "news", transport: "rest_poll" },
  { id: "fed-press", name: "Federal Reserve Wire", category: "news", transport: "rest_poll" },
  { id: "macro-cnbc", name: "CNBC Markets", category: "macro", transport: "rest_poll" },
  { id: "macro-treasury", name: "U.S. Treasury Rates", category: "macro", transport: "rest_poll" },
  { id: "macro-fred", name: "FRED Macro Series", category: "macro", transport: "rest_poll" },
  { id: "the-block", name: "The Block", category: "news", transport: "rest_poll" },
  { id: "blockworks", name: "Blockworks", category: "news", transport: "rest_poll" },
  { id: "exchange-news", name: "Exchange Announcements", category: "news", transport: "rest_poll" },
