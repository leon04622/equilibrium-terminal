...
const COMMANDS: CommandDefinition[] = [
  ...
  },
  {
    ...
    aliases: ["notes"],
    label: "Journal",
    description: "Operator journal & session notes",
    category: "workspace",
    template: "/journal",
    wedgeGated: true,
  },
  ...
  },
  {
    id: "paper",
    primary: "/paper",
    aliases: ["/blotter", "blotter"],
    label: "Paper blotter",
    description: "Paper positions, P&L, and fill tape",
    category: "execution",
    template: "/paper",
  },
  {
    id: "operator",
    primary: "/operator",
    aliases: ["mode", "workflow"],
    label: "Operator Mode",
    description: "Daily operating workflow — morning, trading, review",
    category: "workspace",
    template: "/operator",
  },
  {
