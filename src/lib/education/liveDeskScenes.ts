/**
 * LIVE DESK v1 — STABILITY FREEZE
 *
 * Platform-specific academy module. Teaches Equilibrium Terminal's real-time
 * desk awareness strip. Do not break scene contracts without bumping to v2.
 */
...
export const LIVE_DESK_SCENES: LDScene[] = [
  ...
  },
  {
    ...
    voice:
      "Live Desk combines every awareness signal in one header strip. Funding countdown — time to the next hourly carry window. Session countdown — time to the next session transition. Desk tone — CALM, ACTIVE, THIN, FUNDING WINDOW, or STRESS. Market state — volatility, liquidity, and risk-on-off. Alerts and operational signals surface when conditions shift. This is Equilibrium Terminal's mission control — not generic chart watching.",
    takeaway: "Funding · session · tone · vol · liq · risk · alerts — one heartbeat.",
    visual: "components",
    holdMs: 3200,
  },
  {
  ...
  },
  {
    ...
    voice:
      "Live Desk is the heartbeat of the trading day on Equilibrium Terminal. You learned what it is, why it exists, and how professionals use it. Next: find the real Live Desk strip in your terminal header and walk through each component live.",
