...
const PROGRESS_KEY = "eq-market-structure-progress-v1";
...
export interface MarketStructureLessonState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useMarketStructureLessonStore = create<MarketStructureLessonState>((set, get) => {
