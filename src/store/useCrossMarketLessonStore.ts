...
const PROGRESS_KEY = "eq-cross-market-progress-v1";
...
export interface CrossMarketLessonState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useCrossMarketLessonStore = create<CrossMarketLessonState>((set, get) => {
