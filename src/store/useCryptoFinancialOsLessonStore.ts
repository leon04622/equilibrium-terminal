...
const PROGRESS_KEY = "eq-crypto-financial-os-progress-v1";
...
export interface CryptoFinancialOsLessonState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useCryptoFinancialOsLessonStore = create<CryptoFinancialOsLessonState>((set, get) => {
