...
const PROGRESS_KEY = "eq-daily-operations-progress-v1";
...
export interface DailyOperationsLessonState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useDailyOperationsLessonStore = create<DailyOperationsLessonState>((set, get) => {
