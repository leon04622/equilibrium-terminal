...
const PROGRESS_KEY = "eq-macro-flows-progress-v1";
...
export interface MacroFlowsLessonState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useMacroFlowsLessonStore = create<MacroFlowsLessonState>((set, get) => {
