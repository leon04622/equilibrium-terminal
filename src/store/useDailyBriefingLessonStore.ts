...
const PROGRESS_KEY = "eq-daily-briefing-progress-v1";
...
export interface DailyBriefingLessonState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useDailyBriefingLessonStore = create<DailyBriefingLessonState>((set, get) => {
