...
const PROGRESS_KEY = "eq-first-trade-progress-v1";
...
export interface FirstTradeLessonState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useFirstTradeLessonStore = create<FirstTradeLessonState>((set, get) => {
