...
const PROGRESS_KEY = "eq-funding-crowding-progress-v1";
...
export interface FundingCrowdingState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useFundingCrowdingStore = create<FundingCrowdingState>((set, get) => {
