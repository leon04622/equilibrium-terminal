...
const PROGRESS_KEY = "eq-execution-progress-v1";
...
export interface ExecutionLessonState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useExecutionLessonStore = create<ExecutionLessonState>((set, get) => {
