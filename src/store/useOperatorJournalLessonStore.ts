...
const PROGRESS_KEY = "eq-operator-journal-progress-v1";
...
export interface OperatorJournalLessonState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useOperatorJournalLessonStore = create<OperatorJournalLessonState>((set, get) => {
