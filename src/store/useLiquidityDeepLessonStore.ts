...
const PROGRESS_KEY = "eq-liquidity-deep-progress-v1";
...
export interface LiquidityDeepLessonState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useLiquidityDeepLessonStore = create<LiquidityDeepLessonState>((set, get) => {
