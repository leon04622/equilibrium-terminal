...
const PROGRESS_KEY = "eq-market-memory-progress-v1";
...
export interface MarketMemoryLessonState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useMarketMemoryLessonStore = create<MarketMemoryLessonState>((set, get) => {
