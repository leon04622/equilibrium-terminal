...
const PROGRESS_KEY = "eq-intelligence-desk-progress-v1";
...
export interface IntelligenceDeskLessonState {
  active: boolean;
  runId: number;
  startStep: number;
  completed: boolean;
...
export const useIntelligenceDeskLessonStore = create<IntelligenceDeskLessonState>((set, get) => {
